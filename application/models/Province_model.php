...
class Province_model extends MY_Model
{
    ...
    {
        return $this->db->select('classes.id,classes.class')->from('class_sections')->join('sections', 'class_sections.section_id=sections.id')->where('class_id', $id)->get()->result_array();
    }
