                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                data-target="#addExamModal" autocomplete="off"><i class="fa fa-plus"></i>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('/cbseexam/exam/show/'.$value['id']) ?>"><?php echo $value['name']; ?></a></td>
                                        <td><?php echo $value['subject_name']; ?></td>
                                        <td><?php echo $value['classse_name']; ?></td>
                                        <td><?php echo $value['so_tc']; ?></td>
                                        <td><?php echo $value['so_gio']; ?></td>
                                        <td><?php echo $value['lt']; ?></td>
                                        <td><?php echo $value['th']; ?></td>
                                        <td><?php echo $value['type'] == 1 ? 'Học phần tự chọn' : 'Học phần bắt buộc'; ?>
                                        </td>
                                        <td><?php echo $value['bac_dao_tao']; ?></td>
                                        <td><?php echo $value['term_name']; ?></td>
                                        <td><?php echo $this->customlib->dateformat($value['created_at']); ?></td>
                                        <td class="text-right white-space-nowrap">

                                            <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-subject_name="<?php echo $value['subject_name']; ?>" data-target="#subjectModal" data-exam_id="<?php echo $value['id']; ?>"><i class="fa fa-newspaper-o"  aria-hidden="true"></i></button>
                                            
                                            <?php  if ($this->rbac->hasPrivilege('cbse_exam_assign_view_student', 'can_view')) { ?>

                                            <button data-toggle="tooltip" title=""
                                                class="btn btn-default btn-xs assignStudent" id="load"
                                                data-examid="<?php echo $value['id']; ?>"
                                                data-original-title="<?php echo $this->lang->line('assign_view_student'); ?>"><i
                                                    class="fa fa-tag"></i></button>

                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam_marks', 'can_view')) { ?>

                                            <button class="btn btn-default btn-xs examMarksSubject"
                                                data-toggle="tooltip" data-recordid="<?php echo $value['id']; ?>"
                                                title="<?php echo $this->lang->line('exam_marks'); ?>"><i
                                                    class="fa fa-newspaper-o"></i></button>

                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam_attendance', 'can_view')) { ?>

                                            <button class="btn btn-default btn-xs examattendance" data-toggle="tooltip"
                                                data-recordid="<?php echo $value['id']; ?>"
                                                title="<?php echo $this->lang->line('exam_attendance'); ?>"><i
                                                    class="fa fa-calendar-check-o ftlayer"></i></button>

                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam_teacher_remark', 'can_view')) { ?>

                                            <button class="btn btn-default btn-xs examTeacherReamark"
                                                data-toggle="tooltip" data-recordid="<?php echo $value['id']; ?>"
                                                title="<?php echo $this->lang->line('teacher_remark'); ?>"><i
                                                    class="fa fa-comment"></i></button>

                                            <?php } if ($this->rbac->hasPrivilege('cbse_exam', 'can_edit')) { ?>

                                            <button class="btn btn-default btn-xs editexamModalButton"
                                                data-toggle="tooltip" data-exam_id="<?php echo $value['id']; ?>"
                                                title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"
                                                    aria-hidden="true"></i></button>

                                            <?php } ?>

                                            <?php if ($this->rbac->hasPrivilege('cbse_exam_generate_rank', 'can_view')) { ?>
                                            <a href="<?php echo site_url('cbseexam/exam/examwiserank/'.$value['id']);?>"
                                                data-toggle="tooltip" title="" class="btn btn-default btn-xs" id="load"
                                                data-examid="<?php echo $value['id']; ?>"
                                                data-original-title="<?php echo $this->lang->line('generate_rank'); ?>"><i
                                            ...
                                            <span data-toggle="tooltip"
                                                ...
                                                <button class="btn btn-default btn-xs deleteexam"
                                                    data-id="<?php echo $value['id']; ?>" data-exam="yk" id="deleteItem"
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal-title">Thêm lớp học phần</h4>
            </div>
                ...
                <form role="form" id="add_exam_form" method="post" enctype="multipart/form-data" action="">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên lớp học phần</label> <small class="req">
                                        *</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mã lớp học phần</label> <small class="req">
                                        *</small>
                                    <input class="form-control" name="exam_code" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="d-flex">
                                    <div class="">
                                        <label class="d-flex align-items-center">
                                            <input type="radio" value="1" name="type">&nbsp;&nbsp;Học phần tự chọn
                                        </label>
                                    </div>
                                    <div class="checkbox-inline">
                                        <label class="d-flex align-items-center">
                                            <input type="radio" value="2" name="type">&nbsp;&nbsp;Học Phần bắt buộc
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="bac_dao_tao_id" name="bac_dao_tao_id">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label>Khóa học</label><small class="req"> *</small>
                                    <select name="exam_term_id" id="exam_term_id" class="form-control">
                                        <option value=""><?php echo $this->lang->line('select')?></option>
                                        <?php 
                                         foreach ($term_list as $term_key => $term_value) {
                                            ?>
                                        <option value="<?php echo $term_value->id;?>">
                                            <?php echo $term_value->name." (".$term_value->term_code.")";?></option>
                                        <?php
                                         }
                                         ?>
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('assessment'); ?></label><small class="req">
                                        *</small>
                                    ...
                                    foreach ($assessment_result as $assessment) {
                                        ...
                                        ?> value="<?php echo $assessment['id'] ?>"><?php echo $assessment['name'] ?>
                                        </option>
                                        <?php
                                        }
                                        ?>
                        ...
                        <table class="table table-bordered" id="item_table">
                            <thead>
                                <tr>
                                    <th class="">Học phần<small class="req"> *</small></th>
                                    <th class="">Số tín chỉ<small class="req"> *</small></th>
                                    <th class="">Lý thuyết<small class="req"> *</small></th>
                                    <th class="">Thực hành<small class="req"> *</small></th>
                                    <th class="">Thời lượng (giờ)<small class="req"> *</small></th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <select class="form-control item_unit tddm100" name="subject_id">
                                            <option value=""><?php echo $this->lang->line('select')?></option>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input placeholder="Số tín chỉ" class="form-control" name="so_tc" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <input placeholder="Số tiết lý thuyết" class="form-control" name="lt" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <input placeholder="Số tiết thực hành" class="form-control" name="th" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <input class="form-control" name="so_gio" />
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary pull-right"
                            data-loading-text="<?php echo $this->lang->line('submitting') ?>"
...
(function($) {
    "use strict";
    var date_format =
        '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy','M'=>'MM']) ?>';

    var date_format_time =
        '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'DD', 'm' => 'MM', 'Y' => 'YYYY','M'=>'MMM']) ?>';

    $(document).ready(function() {
        modal_click_disabled('subjectModal', 'addExamModal', 'observationParameterModal',
            'teacherRemarkModal', 'allotStudentModal', 'addSubject', 'editexamModal',
            'observationModal', 'subjectmarkModal');
    ...
    $('#addExamModal,#editexamModal').on('hidden.bs.modal', function() {
        ...
        $('.custom-select-option-box').closest('div').find("input[name='select_all']").attr('checked',
            false);
    ...
    $(document).on('click', '.add', function() {
        ...
        html += '<tr>';
        html += '<td ><select name="subject_' + x + '" class="form-control item_unit tddm200">' +
            batch_subjects + '</select></td>';
        html += '<td><div class="input-group datepicker_init"><input type="text" name="date_from_' + x +
            '" class="form-control"/><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div></td>';
        html += '<td><div class="input-group datepicker_init_time"><input type="text" name="time_from' + x +
            '" class="form-control"/><span class="input-group-addon" id="basic-addon2"><i class="fa fa-clock-o"></i></span></div></td>';
        html += '<td><input type="text" name="duration' + x +
            '" class="form-control duration" value="0"/></td>';
        html += '<td class="" ><input type="text" name="room_no_' + x +
            '" class="form-control room_no" /><input type="hidden" name="rows[]" value="' + x +
            '"> <input name="prev_row[' + x + ']" type="hidden" value="0"></td>';
        html +=
            '<td class="text-center" ><span class="text text-danger remove fa fa-times mt5"></span></td></tr>';
    ...
    $(document).on('submit', '.ssaddSubject', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) { // if error occured
                alert(
                    "<?php echo $this->lang->line('error_occured').", ".$this->lang->line('please_try_again')?>"
                    );
...
$(document).on('click', function(event) {
    if (event.target.className != "custom-select" && !$(event.target).closest('div').hasClass(
