                ...
                <div class="box box-primary" <?php
                    ...
                    <div class="box-body box-profile pt0">
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('subject_group'); ?></b> <a class="pull-right text-aqua"><?php echo $student['classesSubject']; ?></a>
                            </li>
            ...
            <div class="col-12">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        ?>
                        <!------- CBSE Exam End-------->
                        <li class=""><a href="#subjectgroup" data-toggle="tab" aria-expanded="true">Chương trình đào tạo</a></li>
                        <li class=""><a href="#learningoutcomes" data-toggle="tab" aria-expanded="true">Kết quả học tập</a></li>
                    ...
                    <div class="tab-content">
                                    ...
                                    <table class="table table-bordered table-striped" border="0" style="width: 100%;">
                                        <thead>
                                            <tr class="kTableHeader">
                                                ...
                                                <td class="td" style="text-align: center;">Số tín chỉ
                                                </td>
                                                <td class="td" style="text-align: center;" >Đơn giá
                                                </td>
                                                <td class="td" style="text-align: center;">Thành tiền
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="kTableRow">
                                                ...
                                                <td class="td text-right"> <?php echo number_format($group_subject_value->credit,2); ?></td>
                                                <td class="td text-right"><?php echo amountFormat($student['unit_price']).' '.$currency_symbol; ?></td>
                                                <td class="td text-right"><?php echo amountFormat($student['unit_price']*$group_subject_value->credit).' '.$currency_symbol; ?></td>
                                            </tr>
                                            <?php $credit+=$group_subject_value->credit ;$i++;endforeach ?>
                                            <tr class="kTableRow">
                                                <td class="td text-right" colspan="3"><b>Tổng số tín chỉ</b></td>
                                                <td class="td text-right"><b><?php echo number_format($credit,2); ?></b></td>
                                                <td class="td text-right"></td>
                                                <td class="td text-right"><b><?php echo amountFormat($credit*$student['unit_price']) .' '.$currency_symbol; ?></b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <!------- Learning outcomes-------->
                        <div class="tab-pane" id="learningoutcomes">
                            <div class="dt-buttons btn-group pull-right miusDM42">
                                <a class="btn btn-default btn-xs dt-button no_print border0" id="print" data-toggle="tooltip" data-placement="bottom" title="Print" onclick="printDivCbse()"><i class="fa fa-print"></i></a>
                            </div>

                            <div class="row">
                                <form method="post" action="<?php echo site_url('student/entrymarks') ?>" id="assign_form1111">
                                    <input type="hidden" name="student_id" value="<?= $student['id']; ?>">                                
                                    <?php if (isset($resultlist_mark) && !empty($resultlist_mark)): ?>
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr class="kTableHeader">
                                                    ...
                                                    <td style="width:150px" class="text-center">Trạng thái
                                                    </td>
                                                    <td>Miễn môn học
                                                    </td>
                                                </tr>
                                            </thead>
                                                <?php if (empty($resultlist_mark)) { ?>
                                                <tr>
                                                    <td colspan="10" class="text-danger text-center"><?php echo $this->lang->line('no_record_found'); ?></td>
                                                </tr>
                                                <?php } else { $i=1; foreach ($resultlist_mark as $subject_student) { ?>
                                                <tr class="std_adm_<?php echo $subject_student['admission_no']; ?>">
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <?php echo $subject_student['subjects_name']; ?>
                                                    <input type="hidden" value="<?= $subject_student['id']; ?>" name="subject_student_id[]">
                                                </td>
                                                <td><?php echo $subject_student['subjects_code']; ?></td>
                                                <td>
                                                    <input type="text" class="form-control note noteinput" 
                                                    name="mark[<?php echo $subject_student['id'];?>][diem_kt_1]" 
                                                    value="<?php if(!empty($subject_student['marks'][$value['id']]['note'])){ echo $subject_student['marks'][$value['id']]['note']; } ?>">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control note noteinput" 
                                                    name="mark[<?php echo $subject_student['id'];?>][diem_kt_2]" 
                                                    value="<?php if(!empty($subject_student['marks'][$value['id']]['note'])){ echo $subject_student['marks'][$value['id']]['note']; } ?>">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control note noteinput" 
                                                    name="mark[<?php echo $subject_student['id'];?>][diem_thi_1]" 
                                                    value="<?php if(!empty($subject_student['marks'][$value['id']]['note'])){ echo $subject_student['marks'][$value['id']]['note']; } ?>">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control note noteinput" 
                                                    name="mark[<?php echo $subject_student['id'];?>][diem_thi_2]" 
                                                    value="<?php if(!empty($subject_student['marks'][$value['id']]['marks'])){ echo $student['marks'][$value['id']]['marks']; } ?>">
                                                </td>
                                                <td style="width:150px" class="text-center">
                                                    <?php echo check_trang_thai_monhoc($subject_student['status']) ?>
                                                </td>
                                                <td><label class="d-flex align-items-center gap-0-5">
                                                    <input type="checkbox" <?php $subject_student['mien_hoc'] == 1 ? 'checked' : '' ?> name="mien_hoc[<?php echo $subject_student['id'];?>]" class="check_absent mt-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Đánh dấu miễn môn</font></font></label></td>
                                                </tr>
                                                <?php $i++; }} ?>
                                        </table>
                                    </div>
