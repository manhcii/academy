            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('student_list_credit'); ?></h3>
                    </div>
                    <div class="box-body">
                            ...
                            <form role="form" action="<?php echo site_url('student/searchvalidation') ?>" method="post" class="class_search_form">
                                <div class="col-md-12">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="class_id" name="class_id" class="form-control">
                                                    ...
                                                    ?>
                                                        ...
                                                        // if (set_value('id') == $class['id'] || ($class_id && $class_id == $class['id'])) {
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('section_credit'); ?></label><small class="req"> *</small>
                                                <select id="section_id" name="section_id" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php
                                                    if ($sectionlist) {
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select id="section_id" name="section_id" class="form-control">
                                                    ...
                                                    <option value="2">Đã qua</option>
                                                    <option value="3">Không qua</option>
                                                </select>
                    ...
                    <div class="nav-tabs-custom border0 navnoshadow">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <!--<li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> -->
                    ...
                    if (!response.status) {
                        ...
                        table = $('.student-list').DataTable({
                            ...
                            "drawCallback": function(settings) {
                                console.log(settings.json.student_detail_view);
