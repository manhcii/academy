...
<?php }?>
                                        ...
                                        <!--            <button type="button" class="btn btn-sm btn-primary mysiblings anchorbtn"><i class="fa fa-plus"></i> -->
                                                        <?php //echo $this->lang->line('add_sibling'); ?>
                                        <!--            </button>-->
                                        <!--        </div>-->
                                        <!--        <div class="col-lg-7 col-md-6 col-sm-9 col-xs-7">-->
                                        <!--            <div class="pt6 overflowtextdot">-->
                                        <!--                <span id="sibling_name" class="label label-success">-->
                                                            <?php //echo set_value('sibling_name'); ?>
                                        <!--                </span></div>-->
                                        <!--        </div>-->
                                        <!--    </div>-->
                                        <!--</div>-->
    ...
    ?>
                                <div class="tshadow mb25 bozero sibling_div relative">
                                    ...
                                    <div class="box-tools sibbtnposition">
                                        <button type="button" class="btn btn-primary btn-sm remove_sibling">
                                            <?php echo $this->lang->line('remove_sibling'); ?>
                                        </button>
                                    </div>
                                    <div class="around10">
                                        <div class="row">
