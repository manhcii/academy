                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#menuModal">
                                <?php echo $this->lang->line('add_menu'); ?></button>
                            <?php }?>
...
<div id="menuModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" action="<?php echo site_url("admin/sidemenu/add_menu") ?>"
                id="form_add_menu">
                    ...
                    <div class="box-body pt0 pb0">
                        <div class="form-group row">
                            <label class="control-label col-sm-3"
                                for="menu"><?php echo $this->lang->line('menu'); ?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="menu" name="menu"
                                    placeholder="<?php echo $this->lang->line('enter_menu'); ?>">
                            </div>
                        </div>
                            <label class="control-label col-sm-3"
                                for="lang_key"><?php echo $this->lang->line('language_key'); ?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="lang_key" name="lang_key"
                                    placeholder="<?php echo $this->lang->line('enter_language_key'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3"
                                for="icon"><?php echo $this->lang->line('icon'); ?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="icon" name="icon"
                                    placeholder="<?php echo $this->lang->line('enter_icon'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3"
                                for="activate_menu"><?php echo $this->lang->line('active_menu_array_key'); ?></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="activate_menu" name="activate_menu"
                                    placeholder="<?php echo $this->lang->line('enter_active_menu_array_key'); ?>">
                                <small class="text-secondary">Like Front Office Top Array Key</small>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3"
                                for="access_permissions"><?php echo $this->lang->line('access_permissions'); ?></label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="access_permissions" name="access_permissions"
                                    placeholder="<?php echo $this->lang->line('enter_permissions'); ?>"
                                    rows='5'></textarea>
                                <small class="text-secondary">Like ('collect_fees', 'can_view') ||
                                    ('search_fees_payment', 'can_view')</small>
                            </div>
                        </div>
                        <div class="form-group mb0">
                            <div class="col-sm-offset-3 col-sm-9">
                                <div class="checkbox">
                                    <label><input type="checkbox" name="sidebar_view" value="1" checked="checked">
                                        <?php echo $this->lang->line('list_in_sidebar'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm" id="load" data-action="collect"
                        data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i><?php echo $this->lang->line('processing'); ?> "
                        autocomplete="off"> <?php echo $this->lang->line('save'); ?> </button>
                </div>
            </form>
        </div>
    </div>
...
<div id="submenuModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <form class="form-horizontal" method="POST" action="<?php echo site_url("admin/sidemenu/add_sub_menu") ?>"
                id="form_add_submenu">
                <input type="hidden" name="menu_id" value="0" id="menu_id">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="menu"><?php echo $this->lang->line('sub_menu'); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="menu" name="menu"
                                placeholder="<?php echo $this->lang->line('enter_menu'); ?>">
                        </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="url"><?php echo $this->lang->line('url_controller_action'); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="url" name="url"
                                placeholder="<?php echo $this->lang->line('enter_url'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="controller"><?php echo $this->lang->line('controller'); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="activate_controller" name="activate_controller"
                                placeholder="<?php echo $this->lang->line('enter_controller'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="controller"><?php echo $this->lang->line('methods'); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="activate_methods" name="activate_methods"
                                placeholder="<?php echo $this->lang->line('enter_methods'); ?>">
                            <small class="text-secondary">Like index,edit,view,delete</small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="access_permissions"><?php echo $this->lang->line('Access Permissions'); ?></label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="access_permissions" name="access_permissions"
                                placeholder="<?php echo $this->lang->line('enter_permissions'); ?>" rows='5'></textarea>
                            <small class="text-secondary">Like ('collect_fees', 'can_view') || ('search_fees_payment',
                                'can_view')</small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3"
                            for="controller"><?php echo $this->lang->line('check_addon_permission'); ?></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="addon_permission" name="addon_permission"
                                placeholder="<?php echo $this->lang->line('enter_permissions'); ?>">
                            <small class="text-secondary">if link is for addon, Provide addon short code to check addon
                                is registered</small>
                        </div>
                    </div>
                </div>
...
$(document).on('click', '.edit_sub_menu', function() {
    ...
    $.ajax({
        ...
        data: {
            "submenu_id": record_data.recordId
        },
        dataType: "json",
        ...
        success: function(data) {
            ...
            $("textarea[name='access_permissions']", $('#submenuModal')).val(submenu
                .access_permissions);
            $("input[name='menu']", $('#submenuModal')).val(submenu.menu);
            $("input[name='activate_controller']", $('#submenuModal')).val(submenu
                .activate_controller);
