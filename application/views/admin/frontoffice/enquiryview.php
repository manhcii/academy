            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Hồ sơ tuyển sinh</h3>
                    </div>
                    <div class="col-md-12">
                            ...
                            <div class="box-header with-border">
                                <div class="pull-right">
                                    <?php if ($this->rbac->hasPrivilege('admission_enquiry', 'can_add')) { ?>
                                        <a href="<?= base_url('admin/enquiry/create') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                                    <?php } ?>
                                </div><!-- /.box-tools -->
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-name">
                                                                <?php if ($this->rbac->hasPrivilege('follow_up_admission_enquiry', 'can_view')): ?>
                                                                    <a class="text-primary" href="javascript:void(0)" onclick="follow_up('<?php echo $value['id']; ?>', '<?php echo $value['status']; ?>', '<?php echo $value['created_by']; ?>');" data-target="#follow_up" data-toggle="modal" title="<?php echo $value['name']; ?>">
                                                                        <?php echo $value['name']; ?>
                                                                    </a>
                                                                <?php else: ?>
                                                                <?php echo $value['name']; ?>
