            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Danh sách xét tuyển</h3>
                    </div>
                    <div class="col-md-12">
                        <?php echo $this->session->flashdata('msg');
                        $this->session->unset_userdata('msg'); ?>
                    </div>
                    <form role="form" action="<?php echo site_url('admin/enquiry/danh_sach_xet_tuyen') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-3 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label>Ngày yêu cầu<small class="req"> *</small></label>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-name">
                                                                <?php if ($this->rbac->hasPrivilege('follow_up_admission_enquiry', 'can_view')): ?>
                                                                    <a href="javascript:void(0)" onclick="follow_up('<?php echo $value['id']; ?>', '<?php echo $value['status']; ?>', '<?php echo $value['created_by']; ?>');" data-target="#follow_up" data-toggle="modal" title="<?php echo $value['name']; ?>">
                                                                        <?php echo $value['name']; ?>
                                                                    </a>
                                                                <?php else: ?>
                                                                <?php echo $value['name']; ?>
                                                            ...
                                                            <td> <?php echo $value["khoa_hoc"] ? $value["khoa_hoc"] : 'Đang cập nhật' ?></td>
