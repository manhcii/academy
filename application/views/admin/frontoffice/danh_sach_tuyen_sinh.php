            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Danh sách tuyển sinh</h3>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="bordertop">
                            <div class="box-header with-border">
                                <div class="pull-right">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" id="openModalAddStudent"><i class="fa fa-plus"></i> Nhập học sinh viên</button>
                                    <?php endif; ?>
                                </div><!-- /.box-tools -->
                            </div><!-- /.box-header -->
                            <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Số lượng sinh viên</label><small class="req"> *</small>
                                            <input type="number" class="form-control" placeholder="Số lượng sinh viên" id="profileNum" name="profile_num" onchange="selectStudent(this)">
                                            <span class="text-danger"><?php echo form_error('section_id'); ?></span>
                                        </div>
                                    </div>
                                </div><!--./row-->
...
<script>
    ...
    $("#openModalAddStudent").click(function() {
        ...
        $('#profileNum').val(count_student ? count_student : '');
    });
    ...
    function selectStudent(e)
    {
        var count = $(e).val();
        var i = 1;
        $('.student_select').prop('checked', false);
        $('.student_select').each(function(){
            $(this).prop('checked', true);
            $('.count_student').html(i);
            i++;
            if(i > count)
            {
                return false;
...
<script>
    ...
    $("#addStudents").validate({
		rules: {
    			class_id: "required",
    			section_id: "required",
    			profile_num: "required", 
    			subject_group: "required", 
    		},
    		messages: {
    			class_id: "Vui lòng chọn chuyên ngành",
    			profile_num: "Vui lòng chọn sinh viên",
    			section_id: "Vui lòng chọn lớp học",
    			subject_group: "Vui lòng chọn chương trình đào tạo",
    		},
    		submitHandler: function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        // } else {
                            successMsg(res.message);
                            window.location.href="<?= base_url('student/search')?>";
                        // }
                    },
                    error: function(xhr) { // if error occured
                        // window.location.reload(true);
