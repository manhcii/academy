    ...
    ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="positions" name="positions[]" class="form-control" multiple="multiple">
                                                    ...
                                                    foreach ($positions as $key => $position) {
                                                        $selected = in_array($position['id'], explode(",", $staff['positions'])) ? 'selected' : '';
                                                    ?> 
                                                        <option value="<?php echo $position['id'] ?>" <?php echo $selected; ?> <?php echo set_select('positions[]', $position['id'], set_value('positions[]')); ?>><?php echo $position["name"]; ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="subjects" name="subjects[]" class="form-control" multiple="multiple">
                                                    ...
                                                    foreach ($subjects as $key => $subject) {
                                                        $selected = in_array($subject['id'], explode(",", $staff['subjects'])) ? 'selected' : '';
                                                    ?>
                                                        <option value="<?php echo $subject['id'] ?>" <?php echo $selected; ?> <?php echo set_select('subjects[]', $subject['id'], set_value('subjects[]')); ?>><?php echo $subject["name"]; ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea style="height: 32px;" id="graduate_expertise" name="graduate_expertise" placeholder="" class="form-control"><?php echo $staff['graduate_expertise'] ?></textarea>
        ...
        ?>
                                                            <option value="<?php echo $value["id"] ?>" <?= $staff["class"] == $value["id"] ? "selected" : '' ?> ><?php echo $value["class"] ?></option>
                                                        <?php }
    ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="type_of_teacher" name="type_of_teacher" placeholder="" type="text" class="form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $value["id"] ?>" <?= $value['id'] == $staff['teacher_category'] ? "selected" : '' ?> ><?php echo $value["name"] ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('class'); ?></span>
