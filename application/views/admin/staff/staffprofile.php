                ...
                <div class="box box-primary" <?php
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('class'); ?></b> <a class="pull-right text-aqua"><?php echo $class_name; ?></a>
                                </li>
                                <? $tyofteacher = ''; foreach($teachercategory as $item) { $item['id'] == $staff['teacher_category'] ? $tyofteacher = $item['name'] : ''; } ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('type_of_teacher'); ?></b> <a class="pull-right text-aqua"><?php echo $tyofteacher; ?></a>
                                </li>
                            <?php
                            if ($sch_setting->staff_epf_no) { ?>
                                <li class="list-group-item listnoback displaynone">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="" style="display:none"><a href="#attendance" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('attendance'); ?></a></li>
                        ...
                        <?php if ($this->rbac->hasPrivilege('staff_timeline', 'can_view')) { ?>
                            <li style="display:none" class=""><a href="#timelineh" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('timeline'); ?></a></li>
                        <?php } ?>
                                    ...
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $staff['positions']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('subject_teaching'); ?></td>
                                                <td><?php echo $staff['subjects']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('graduate_expertise'); ?></td>
                                                <td><?php echo $staff['graduate_expertise']; ?></td>
                                            </tr>
