                    ...
                    ?>
                        ...
                        <div class="nav-tabs-custom border0">
                            <ul class="nav nav-tabs">
                                <li style="display:none" class=""><a href="#tab_1" data-toggle="tab" aria-expanded="true"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('card_view'); ?></a></li>
                                <li class="active"><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i class="fa fa-list"></i> <?php echo $this->lang->line('list_view'); ?></a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="download_label"><?php echo $title; ?></div>
                                <div class="tab-pane table-responsive no-padding active" id="tab_2">
