    ...
    ?>
                <section class="sidebar <?php echo ($is_lock_panel) ? "disable-sidebar" : "" ?>">
                    ...
                    <ul class="sidebar-menu verttop38" id="sibe-box">
                        ...
                        <li class="<?php echo set_Topmenu('my_profile'); ?>"><a href="<?php echo base_url(); ?>user/user/viewcourseindustry"><i class="fa fa-user-plus ftlayer"></i> <span>Chương trình đào tạo</span></a></li>
...
$ntf = $this->customlib->getUserunreadNotification();
        ...
        ?>
                        ...
                        <?php if ($this->module_lib->hasActive('transport') && $this->studentmodule_lib->hasActive('transport_routes')) {?>
                            <li class="<?php echo set_Submenu('route/index'); ?>"><a href="<?php echo base_url(); ?>user/route"><i class="fa fa-bus "></i> <span><?php echo $this->lang->line('transport_routes'); ?></span></a></li>
                        <?php }?>
