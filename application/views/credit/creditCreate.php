                    ...
                    <form action="<?php echo site_url('sections/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('section_credit'); ?></label>
                                <input autofocus="" id="section_credit" name="section_credit" placeholder="" type="text" class="form-control"  value="<?php echo set_value('section_credit'); ?>" />
