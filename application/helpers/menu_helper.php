...
if (!function_exists('main_menu_array')) {
    ...
    {  
        $array = array(
            ...
            'front_office' => array(
                'enquiry'         => array('index','create','edit','details','danh_sach_xet_tuyen','danh_sach_trung_tuyen','danh_sach_tuyen_sinh'),
            ...
            'lesson_plan' => array(                                 
                ...
                'subjectgroup'  => array('index','edit','add','view'),  
            ...
            'academics' => array(                                 
                ...
                'credits'       => array('index','edit'),
            ), 
            
            'section_class' => array(                                 
                'sectionclass'  => array('index','edit','add'),
            ),
